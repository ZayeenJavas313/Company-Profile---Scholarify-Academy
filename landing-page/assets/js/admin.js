(function () {
  ...
  function updateAdminUI() {
    ...
    if (navBtn) {
      if (isLoggedIn) {
        navBtn.innerHTML = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg><span style="margin-left:6px;font-size:13px">Logout</span>';
        navBtn.title = 'Logout';
        navBtn.setAttribute('aria-label', 'Logout');
        navBtn.onclick = function (e) { e.preventDefault(); doLogout(); };
      } else {
        navBtn.innerHTML = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span style="margin-left:6px;font-size:13px">Login</span>';
        navBtn.title = 'Login';
        navBtn.setAttribute('aria-label', 'Login');
