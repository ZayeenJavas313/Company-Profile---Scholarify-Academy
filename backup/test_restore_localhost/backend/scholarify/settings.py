...
# CORS
# Untuk test localhost, enable semua origins (temporary)
CORS_ALLOW_ALL_ORIGINS = True  # Changed to True for test restore
CORS_ALLOW_CREDENTIALS = True  # Penting untuk credentials: "include"

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost:3001",  # Added for test restore
    "http://127.0.0.1:3001",  # Added for test restore
